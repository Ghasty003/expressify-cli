...
async function createJsFiles(versions: string[], projectName: string, addcors: string) {
...
.env
  ...
  try {
    ...
    for (let folder of folders) {
      ...
      if (folder === "routes") {
        await fs.writeFile(`./${projectName}/${folder}/todo.js`, 
